    ...
    <div className="ml-auto" id="navbarNavDropdown">
      <ul className="navbar-nav">
        <li className="nav-item">
		  ...
		  <Link className=" btn btn-outline-secondary me-2" aria-current="page" to="/characters">Characters</Link>
        </li>
        <li className="nav-item">
		{/* <a className="nav-link active" aria-current="page" href="#">Planets</a> */}
		<Link className=" btn btn-outline-secondary me-2" aria-current="page" to="/planets">Planets</Link>
        </li>
        <li className="nav-item">
		{/* <a className="nav-link active" aria-current="page" href="#">Starships</a> */}
		<Link className=" btn btn-outline-secondary me-2" aria-current="page" to="/starships">Starships</Link>
        </li>
